        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('update.event', ['id' => $event->id])}}" class="form-horizontal" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $event->email }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required autofocus>{{ $event->description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="deadline" type="date" class="form-control{{ $errors->has('deadline') ? ' is-invalid' : '' }}" name="deadline" value="{{ $event->deadline->format('Y-m-d') }}" required>
