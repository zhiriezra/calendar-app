                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="account-pages" style="margin-top: 50%;">
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span>
                                                <!-- <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="" height="36"> -->
                                                <h5 class="text-white">Administrator Login</h5>        
                                            </span>
                                        </a>
                                    </h2>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Don't have an account? Kindly contact and administrator.</p>
                                </div>
                            </div>
